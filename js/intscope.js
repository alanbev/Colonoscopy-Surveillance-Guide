            ...
            if (patient.numb_fdr==="3")
                {
                 if (patient.fdr_multi_gen && patient.fdr_under_50 && !patient.lynch)
                    {
                     if (confirm("Potential Lynch Family \n If genetic testing has not been carried out, the patient should be refered for this.  If genetic testing is not possible consider surveillance as Lynch syndrome. Click OK to treat as presumed Lynch syndrome or Cancel to regard as not being Lynch "))
                        {
                         patient.lynch=true
                        }
                    }
